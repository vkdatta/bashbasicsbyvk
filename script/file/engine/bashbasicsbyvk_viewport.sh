...
# ── Menu chrome callbacks ─────────────────────────────────────────────────────
# These are the _vp_header_fn / _vp_footer_fn implementations used by the
# main file manager loop. They live here because they are direct consumers of
# the viewport state variables defined above (_hl_index, _vp_page, etc.).
...
# ── Viewport navigation helpers (used by _read_choice in main) ────────────────
